...
type ServiceUpdateHttpInput struct {
	ServiceName string `json:"service_name" form:"service_name" comment:"服务名"  validate:"required,min=1"`          //服务名
...
type ServiceAddHttpInput struct {
	ID          string `json:"id" form:"id" comment:"id"  validate:"required,valid_service_name"`
...
type ServiceDeleteInput struct {
	ID int64 `json:"id" form:"id" comment:"服务ID" example:"56" validate:"required"` //id
}
